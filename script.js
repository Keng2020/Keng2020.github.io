    ...
    portfolio: {
        ...
        <div class="portfolio-container">
            ...
            <div class="card" id="card3" onclick="toggleCard('card3')">
                ...
                <p>Developed an innovative Discord bot designed to automate the process of data scraping from a web
                    application, analyze the collected data, and visualize the results. This bot was integrated into a
                    Discord server to provide real-time data insights to users, demonstrating a practical application of web
                    scraping, asynchronous programming, and data visualization techniques in a real-world project.</p>
                <h3>Key Features:</h3>
                <ul>
                    <li>Automated Web Scraping: Utilized Selenium to navigate web pages, perform login operations, and
                        scrape crucial data at predefined intervals.</li>
                    <li>Asynchronous Programming: Implemented asyncio for non-blocking data processing and operations,
                        ensuring efficient task scheduling and execution.</li>
                    <li>Data Analysis & Visualization: Leveraged Pandas for data manipulation and Matplotlib for generating
                        dynamic plots of the scraped data, which are automatically posted to a Discord channel.</li>
                    <li>Real-Time Automation: Designed the bot to run scheduled scraping tasks using Discord.py tasks
                        extension, enabling timely data updates and insights.</li>
                </ul>
                <h3>Achievements:</h3>
                <ul>
                    <li>Successfully deployed the bot in a Discord server, enhancing the community's engagement by providing
                        valuable, real-time data visualizations.</li>
                    <li>Demonstrated proficiency in using Python for web scraping, asynchronous programming, and data
                        analysis & visualization.</li>
                    <li>Applied best practices in software development, including modular programming, to ensure code
